...
describe("Primary API", (function () {
        ...
        Jest.testPromise("it builds a really simple data loader", undefined, (function (param) {
        ...
        Jest.testPromise("it supports loading multiple keys in one call", undefined, (function (param) {
                var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        ...
        Jest.testPromise("it batches multiple requests", undefined, (function (param) {
                var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        ...
        Jest.testPromise("it batches multiple requests with max batch sizes", undefined, (function (param) {
                var calls = /* array */[];
                var batchLoadFun = function (strings) {
                  calls.push(strings);
                  return Promise.resolve($$Array.map((function (string) {
        ...
        return Jest.testPromise("coalesces identical requests", undefined, (function (param) {
                      var calls = /* array */[];
                      var batchLoadFun = function (strings) {
                        calls.push(strings);
                        return Promise.resolve($$Array.map((function (string) {
...
describe("caches repeated requests", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderBatchImpl);
        Jest.testPromise("initial call", undefined, (function (param) {
        ...
        return Jest.testPromise("repeted requests", undefined, (function (param) {
...
describe("clear single value", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        Jest.testPromise("can get a value", undefined, (function (param) {
                var load1a = Curry._1(IdentityLoader[/* load */12], "1");
        ...
        return Jest.testPromise("clears single value in loader", undefined, (function (param) {
...
describe("clear all values", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        Jest.testPromise("loads initial data", undefined, (function (param) {
                var load1a = Curry._1(IdentityLoader[/* load */12], "1");
                var load2a = Curry._1(IdentityLoader[/* load */12], "2");
                return Promise.all(/* array */[
                              load1a,
        ...
        return Jest.testPromise("clears all values in loader", undefined, (function (param) {
...
describe("Priming the cache", (function () {
        Jest.testPromise("it allows priming the cache", undefined, (function (param) {
                var calls = /* array */[];
                var batchLoadFun = function (strings) {
                  calls.push(strings);
                  return Promise.resolve($$Array.map((function (string) {
        ...
        return Jest.testPromise("it does not prime keys that already exist", undefined, (function (param) {
                      var batchLoadFun = function (strings) {
                        return Promise.resolve($$Array.map((function (string) {
                                          return /* Ok */Block.__(0, [string]);
                                        }), strings));
...
describe("Priming the cache by force", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        Jest.testPromise("allows priming the cache", undefined, (function (param) {
                Curry._2(IdentityLoader[/* prime */8], "1", "A");
                var load1a = Curry._1(IdentityLoader[/* load */12], "1");
                var load2a = Curry._1(IdentityLoader[/* load */12], "2");
                return Promise.all(/* array */[
        ...
        return Jest.testPromise("allows forcefully priming the cache", undefined, (function (param) {
                      Curry._1(IdentityLoader[/* clear */6], "1");
