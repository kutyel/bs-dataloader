...
describe("Can handle errors", (function () {
        ...
        return Jest.testPromise("if a error is returned it will return the error", undefined, (function (param) {
                      var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
                      var load1 = Curry._1(IdentityLoader[/* load */12], "1");
                      var load2 = Curry._1(IdentityLoader[/* load */12], "2").catch((function (param) {
...
describe("Does not cache errors", (function () {
        ...
        Jest.testPromise("returns a error the first time", undefined, (function (param) {
                return Curry._1(IdentityLoader[/* load */12], "1").catch((function (param) {
                                return Promise.resolve("error");
                              })).then((function (loadedValue) {
                              return Promise.resolve(Jest.Expect[/* toEqual */12]("error", Jest.Expect[/* expect */0](loadedValue)));
                            }));
              }));
        return Jest.testPromise("returns a value the second time", undefined, (function (param) {
                      return Curry._1(IdentityLoader[/* load */12], "1").catch((function (param) {
                                      return Promise.resolve("error");
                                    })).then((function (loadedValue) {
